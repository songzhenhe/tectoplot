...
void r8vec_std_sample_update ( int nm1, double mean_nm1, double std_nm1, double xn,
...
void r8vec_variance_sample_update ( int nm1, double mean_nm1, double variance_nm1, 
